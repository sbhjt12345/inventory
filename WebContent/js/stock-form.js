...
$('#update').on('click', function() {
	...
	var yearr = parseInt(datearr[0]), monthh = parseInt(datearr[1]), dayy = parseInt(datearr[2]);
	...
	var blabla = qty;
	if (izmap.get(stock_id)!=null){
		blabla += izmap.get(stock_id);
	}
	
	alasql('INSERT INTO trans VALUES(?,?,?,?,?,?,?,?,?)', [ trans_id, stock_id, date, qty,blabla, memo,yearr,monthh,dayy ]);
	// リロード
